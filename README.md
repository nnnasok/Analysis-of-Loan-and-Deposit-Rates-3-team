...
### Исходные данные
- **`loans_ind.xlsx`** - исходный файл с данными по кредитным ставкам
- **`processed_data.csv`** - обработанные данные, готовые для анализа

### Временные ряды
В данных представлены 7 временных рядов кредитных ставок:
...
**Объем данных**: 140 месячных наблюдений

## Модели прогнозирования
1. **ARIMA (AutoRegressive Integrated Moving Average)**
   - Учет трендов и автокорреляции
   - Прогноз на 3 и 6 месяцев
